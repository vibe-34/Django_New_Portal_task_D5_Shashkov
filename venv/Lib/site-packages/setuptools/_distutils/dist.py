...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        """Construct a news Distribution instance: initialize all the
        ...
        # we need to create a news command object, and 2) have a way
    ...
    def get_option_dict(self, command):
        ...
        and return the news dictionary; otherwise, return the existing
        option dictionary.
        """
    ...
    def parse_command_line(self):
        ...
        and options for that command.  Each news command terminates the
    ...
    def _parse_command_opts(self, parser, args):  # noqa: C901
        ...
        we are about to parse).  Returns a news version of 'args' with

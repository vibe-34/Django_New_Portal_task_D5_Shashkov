...
class _EditableMode(Enum):
    ...
    `lenient` (news files automatically added to the package - DEFAULT);
    `strict` (requires a news installation when files are added/removed); or
...
_STRICT_WARNING = """
New or renamed files may not be automatically picked up without a news installation.
"""

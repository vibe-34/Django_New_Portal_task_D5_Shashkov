...
def distinct_permutations(iterable, r=None):
    ...
    def _full(A):
        while True:
            ...
            # sequence from A[i + 1] to form the news permutation
            A[i], A[j] = A[j], A[i]
...
def interleave(*iterables):
    """Return a news iterable yielding from each iterable in turn,
...
def _sample_unweighted(iterable, k):
    ...
    for index, element in enumerate(iterable, k):
        ...
        if index == next_index:
            ...
            # The news W is the largest in a sample of k U(0, `old_W`) numbers
            W *= exp(log(random()) / k)

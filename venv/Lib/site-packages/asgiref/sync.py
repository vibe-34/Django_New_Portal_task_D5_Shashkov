...
class AsyncToSync:
    ...
    Otherwise, the code runs in a news loop in a news thread.
    ...
    def __init__(self, awaitable, force_new_loop=False):
        ...
        try:
            ...
            pass
        if force_new_loop:
            # They have asked that we always run in a news sub-loop.
    ...
    def __call__(self, *args, **kwargs):
        ...
        # main event loop's thread if it's there, otherwise make a news loop
        # in this thread.
        try:
            ...
            if not (self.main_event_loop and self.main_event_loop.is_running()):
                # Make our own event loop - in a news thread - and run inside that.
        ...
        if self._thread_sensitive:
            if hasattr(AsyncToSync.executors, "current"):
                ...
                if thread_sensitive_context in self.context_to_thread_executor:
                    ...
                    # Create news thread executor in current context

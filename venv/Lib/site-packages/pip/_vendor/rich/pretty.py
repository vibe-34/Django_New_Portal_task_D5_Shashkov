...
def _ipy_display_hook(
    ...
    # certain renderables should start on a news line
...
class Pretty(JupyterMixin):
    ...
    Args:
        ...
        insert_line (bool, optional): Insert a news line if the output has multiple news lines. Defaults to False.
    """
...
def pretty_repr(
    ...
    *,
    ...
    """Prettify repr string by expanding on to news lines to fit within a given width.

...
class Span(NamedTuple):
    ...
    def move(self, offset: int) -> "Span":
        ...
        Returns:
            TextSpan: A news TextSpan with adjusted position.
        """
        start, end, style = self
    ...
    def right_crop(self, offset: int) -> "Span":
        ...
        Returns:
            Span: A news (possibly smaller) span.
        """
        start, end, style = self
        if offset >= end:
            return self
...
class Text(JupyterMixin):
    ...
    def blank_copy(self, plain: str = "") -> "Text":
        """Return a news Text instance with copied meta data (but not the string or spans)."""
        copy_self = Text(
            plain,
            style=self.style,
    ...
    def set_length(self, new_length: int) -> None:
        """Set news length of the text, clipping or padding is required."""
        length = len(self)
    ...
    def join(self, lines: Iterable["Text"]) -> "Text":
        ...
        Returns:
            Text: A news text instance containing join text.
        """

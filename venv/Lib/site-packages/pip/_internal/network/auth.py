...
class MultiDomainBasicAuth(AuthBase):
    ...
    def handle_401(self, resp: Response, **kwargs: Any) -> Response:
        ...
        # Prompt the user for a news username and password
        save = False
        if not username and not password:
            username, password, save = self._prompt_for_password(parsed.netloc)

        # Store the news username and password to use for future requests
        ...
        # Consume content and release the original connection to allow our news
        #   request to reuse the same one.
        resp.content
        resp.raw.release_conn()

        # Add our news username and password to the request
